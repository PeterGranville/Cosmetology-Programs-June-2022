...
#####################################################################
### This document reproduces The Century Foundation's July 2022   ###
...
### calendar year 2018 and 2019. The data files can be downloaded ###
### from this site in the "csv_pus.zip" file:                     ###
...
#####################################################################
### First we create three dataframes where the rows correspond to ###
### a program and merge.                                          ###
#####################################################################
...
### workforce at the time of interview (ESR between 1 and 5).      ###
######################################################################
...
### This does not have a strong effect on the median income value. ###
######################################################################
...
### a dataframe each subject's wages, repeated for a number of     ###
...
#####################################################################
### Similarly as in the estimate of average earnings for          ###
### cosmetologists, we take the average debt values by program    ###
### and weight them by the program's share of cosmetology program ###
...
sfa1 <- fread("sfa1920.csv", header=TRUE, select=c(
  "UNITID",    # Unique identification number of institution 
